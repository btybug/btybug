            ...
            <div id="notes-app" class="widget">
                ...
                <div class="widget-header centered transparent">
                    ...
                    <div class="additional-btn">
                        ...
                        <a href="#" class="widget-popout hidden tt" title="Pop Out/In"><i class="fa fa-caret-square-o-up icon-publish"></i></a>
                        <a href="#" class="widget-maximize hidden"><i class="fa fa-arrows-alt icon-resize-full-1"></i></a>
                        <a href="#" class="widget-toggle"><i class="fa fa-chevron-down icon-down-open-2"></i></a>
