        ...
        <div class="col-md-4 builder-modalleft">
            <ul class="filedcolumntype " role="tablist">
                @foreach($layouts as $layout)
                    <li class="">
                        <a  class="styles" data-id="{!! $layout->slug !!}" data-action="page_sections" href="javascript:void(0)">
                ...
                @foreach($layouts[0]->variations() as $item)
                 <ul class="formlisting">
                    ...
                    <a class="btn item" data-value="{!! $item->id !!}" href="javascript:void(0)">
                        <input type="hidden" data-action="page_sections" data-value="{!! $item->id !!}"/> <img src="{!! url('images/form-list2.jpg') !!}">
                    </a>
                        <span>{!! $item->title !!}<a href="#" target="_blank"><i class="fa fa-pencil pull-right" aria-hidden="true"></i></a></span>
